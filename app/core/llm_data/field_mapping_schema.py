    ...
    "users": {
        ...
        "canonical_fields": {
            "name": {
                ...
                "variations": [
                    "full_name", "user_name", "display_name", "username",
                    "first_name_last_name", "employee_name", "person_name"
                ],
                "type": "string",
                "required": True
            },
            "team": {
                ...
                "variations": [
                    "group", "department", "division", "unit", "org",
                    "organization", "dept", "team_name", "work_group"
                ],
                "type": "string",
                "required": False
            },
            "mfa_enabled": {
                ...
                "variations": [
                    "mfa_status", "mfa", "multi_factor_auth", "two_factor",
                    "2fa", "multi_factor_enabled", "mfa_active", "has_mfa",
                    "two_factor_enabled", "multi_factor_authentication"
                ],
                "type": "boolean",
                "required": False,
                "default": False
            ...
            "last_login": {
                ...
                "variations": [
                    "last_access", "last_signin", "last_logged_in",
                    "last_sign_in", "previous_login", "recent_login",
                    "last_activity", "last_access_time"
                ],
                "type": "datetime",
                "required": False
            },
            "assigned_application_ids": {
                ...
                "variations": [
                    "apps", "applications", "app_list", "assigned_apps",
                    "user_applications", "application_access", "app_ids",
                    "accessible_applications", "permitted_apps"
                ],
                "type": "array[string]",
                "required": False,
                "default": []
    ...
    "applications": {
        ...
        "canonical_fields": {
            "name": {
                ...
                "variations": [
                    "app_name", "application_name", "title", "software_name",
                    "system_name", "service_name", "product_name"
                ],
                "type": "string",
                "required": True
            },
            "owner": {
                ...
                "variations": [
                    "owned_by", "responsible_person", "manager", "maintainer",
                    "admin", "administrator", "contact", "responsible_team",
                    "app_owner", "system_owner", "tech_lead"
                ],
                "type": "string",
                "required": True
            },
            "type": {
                ...
                "variations": [
                    "deployment_type", "app_type", "category", "kind",
                    "application_type", "hosting_type", "environment_type",
                    "platform_type", "service_type"
                ],
                "type": "string",
                "required": False,
                "default": "SaaS",
            ...
            "usage_count": {
                ...
                "variations": [
                    "usage", "access_count", "hits", "usage_stats",
                    "access_frequency", "hit_count", "usage_metrics",
            ...
            "integrations": {
                ...
                "variations": [
                    "integrated_systems", "connections", "apis", "connectors",
                    "external_systems", "third_party_integrations", "api_connections",
                    "system_integrations", "linked_services"
                ],
                "type": "array[string]",
                "required": False,
                "default": []
    ...
    "devices": {
        ...
        "canonical_fields": {
            "hostname": {
                ...
                "variations": [
                    "computer_name", "device_name", "machine_name",
                    "host", "system_name", "node_name"
                ],
                "type": "string",
                "required": True
            },
            "ip_address": {
                ...
                "variations": [
                    "ip", "ip_addr", "network_address", "host_ip",
                    "device_ip", "machine_ip", "ipv4_address"
                ],
                "type": "string",
                "required": True
            },
            "os": {
                ...
                "variations": [
                    "operating_system", "platform", "os_type", "system_type",
                    "os_name", "operating_sys", "platform_type"
                ],
                "type": "string",
                "required": False,
                "default": "windows",
            ...
            "assigned_user": {
                ...
                "variations": [
                    "primary_user", "user_id", "owner", "assigned_to",
                    "primary_owner", "device_owner", "responsible_user"
                ],
                "type": "string",
                "required": True
            },
            "location": {
                ...
                "variations": [
                    "physical_location", "site", "office", "building",
                    "room", "floor", "address", "geographical_location"
                ],
                "type": "string",
                "required": True
            },
            "status": {
                ...
                "variations": [
                    "state", "device_status", "operational_status", "condition",
                    "activity_status", "power_status", "connection_status"
                ],
                "type": "string",
                "required": False,
                "default": "inactive",
